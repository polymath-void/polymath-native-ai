...
- **Separation of Concerns**: Keep Python orchestrators, C++ binaries, and Markdown context clearly separated in their respective directories under `~/Projects/polymath-native-ai/`.
